...
// one-time-intent-file-boundary-regression-v4
{
  ...
  if((handoff?.send?.length||0)!==0||(handoff?.withhold?.length||0)!==0||(handoff?.expectBack?.length||0)!==0)throw new Error('Stage 04 must not create any original-intent-file handoff item.');
