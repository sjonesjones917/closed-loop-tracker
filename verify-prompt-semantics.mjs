...
// stage01-practical-intake-regression-v1
{
 ...
 const required=[
  ...
  'Stage 01 should collect foreseeable human-only facts now',
  ...
  'Do not ask the human to choose a technical, legal, filing, design, or execution strategy before the responsible stage researches and explains the supported options',
