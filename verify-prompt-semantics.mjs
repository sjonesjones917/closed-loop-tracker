...
{
 const p=baseProject();
 const complete={id:'VERIFICATION-CONTINUATION',stage:12,active:true,scope:{requirementsVersion:'REQUIREMENTS-v001',testSuiteVersion:'TEST-SUITE-v001',iterationId:'ITERATION-000001',candidateId:'CANDIDATE-000001'},fields:{REQ_ID:'REQ-000001',RUN_ID:'RUN-000001',TEST_ID:'TEST-000001',DETERMINATION:'SATISFIED',EXACT_EVIDENCE:'large prose that must not be replayed in a continuation prompt'}};p.projectData.verification.push(complete);
