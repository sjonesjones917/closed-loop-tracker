...
assert(html.includes('.expandable-prompt{height:280px;max-height:280px}'),'Approved 280px prompt preview baseline changed.');
assert(html.includes('.expandable-prompt.expanded{height:auto;max-height:none}'),'Prompt expansion behavior changed.');
