...
if(!fetched['index.html'].includes('closed-loop-30-runtime-20260823-2030'))throw new Error('Live repaired cache identity is missing.');
if(!fetched['index.html'].includes('experience.js?v=closed-loop-30-runtime-20260823-2030'))throw new Error('Live human-facing experience asset is missing.');
