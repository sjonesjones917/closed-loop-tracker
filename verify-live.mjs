...
if(!fetched['index.html'].includes('closed-loop-30-runtime-20260823-2045'))throw new Error('Live repaired core cache identity is missing.');
if(!fetched['index.html'].includes('experience.js?v=closed-loop-experience-20260823-2055'))throw new Error('Live cache-busted human-facing experience asset is missing.');
if(!fetched['index.html'].includes('Reliability Workbook'))throw new Error('Live cache-distinct human-facing shell heading is missing.');
