...
{const r=await fetch(new URL(`app.js?live=${Date.now()}-${Math.random()}`,base),{cache:'no-store'});if(r.status!==404)throw new Error(`Deleted app.js must return 404; received ${r.status}.`);}
