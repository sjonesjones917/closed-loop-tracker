...
if(!fetched['index.html'].includes('closed-loop-30-runtime-20260823-2025'))throw new Error('Live repaired cache identity is missing.');
if(!fetched['index.html'].includes('closed-loop-retained-project-refresh-20260823-2025'))throw new Error('Live retained-project refresh migration is missing.');
