...
for(const token of ['core.buildStagePrompt=build','const procedures={','const inputCollections={','CONTROLLING PROJECT INPUT','AUTHORIZED INPUTS FOR THIS STAGE','STAGE-SPECIFIC TASK','SOURCE-SET-v001','Do not perform Stage 03 requirements research'])if(!prompts.includes(token))throw new Error(`Live prompt engine missing ${token}.`);
