...
const replacements=[
  ...
  ['Browser storage does not transfer them automatically.</p>','Browser storage does not transfer them automatically; a filename, hash claim, or code block is not file possession.</p>']
];
