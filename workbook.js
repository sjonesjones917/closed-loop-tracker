(async()=>{
  ...
  try{
    ...
    if(localStorage.getItem(revisionKey)!==TEST_SPEC_REVISION){
      for(const registryKey of ["closed-loop-project-registry-v4","closed-loop-project-registry-v3"]){
        try{
