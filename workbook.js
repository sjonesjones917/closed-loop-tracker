...
function migrateState(p){
  ...
  migrated.projectData.migrationArchives.push({kind:'MIGRATION_SOURCE',schema:String(original.schema||'human-project/30'),preservedAt:new Date().toISOString(),payload:original});
