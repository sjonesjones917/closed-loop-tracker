(()=>{
'use strict';
const REVISION='closed-loop-prompt-display-20260824-r1';
...
function refresh(){
  ...
  const prompt=core.buildStagePrompt(core.STAGES[n-1],project);
...
schedule();
globalThis.closedLoopPromptDisplay={revision:REVISION,refresh};
})();
