...
await storageRegression('delete:verified-selection-before-async-refresh',async()=>{
  vm.runInContext('globalThis.operatorActionInFlight=null;globalThis.historyRestoreController=null;globalThis.restoringHistory=false;globalThis.actionControls=new Map();'+appFunction('setControlDisabled'),storageRuntime);
