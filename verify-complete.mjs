...
{
  const p=project('JOB-BAD-REL'),stage=3;for(let n=1;n<stage;n++){p.stages[n].status='COMPLETE';p.stages[n].gate={complete:true,blocked:false,reasons:[]};}const pr=prompt(p,stage);
