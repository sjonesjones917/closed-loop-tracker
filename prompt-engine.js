...
21:'Generate the approved workflow deliverable here, in a fresh production context, using only the approved baseline materials. The approved deliverable may be the requested self-contained product, or it may be the complete implementation-ready specification confirmed at Stage 01 when direct implementation was not reliably available. Before this stage the finished target product is not treated as existing. Assign PRODUCT_ID, PRODUCT_VERSION, BASELINE_ID, EXECUTION_ID, context, timestamps, instruction version, tool configuration, deviations, failures, and generated artifact inventory including filename, type, size, hash, and storage reference. No uncontrolled post-generation editing is permitted.',
