...
s=p.read_text()
replacements=[
("const p=project('JOB-STAGE24-EXACT');p.job.CURRENT_PRODUCT_ID='PRODUCT-24';p.stages[24].agentData.ATTACKS_EXECUTED=['CATEGORY-A','CATEGORY-B','HISTORICAL_REGRESSION:REG-24'];",
 "const p=project('JOB-STAGE24-EXACT');p.job.CURRENT_PRODUCT_ID='PRODUCT-24';p.stages[23].status='COMPLETE';p.stages[24].agentData.ATTACKS_EXECUTED=['CATEGORY-A','CATEGORY-B','HISTORICAL_REGRESSION:REG-24'];"),
