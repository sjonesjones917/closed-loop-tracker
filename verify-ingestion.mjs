...
function savePrompt(p,stage){
  ...
  const options=stage===19?{operation:'COMPARE'}:[11,12,23,24].includes(stage)?{scope:{runId:'RUN-INGESTION-FIXTURE',contextId:'CONTEXT-INGESTION-FIXTURE'}}:{};
