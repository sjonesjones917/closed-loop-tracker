...
// Final boundary: naming a required executable/input artifact is not possession of its bytes.
{
  ...
  if(!proposedTest||!proposedEvidence||!(Array.isArray(proposedTest.evidenceRefs)?proposedTest.evidenceRefs:[]).includes(proposedEvidence.id)||proposedEvidence.ATTACHMENT_ID!==artifactFixtureId(engine,p,'ARTIFACT-TEST-000001'))throw new Error('TEST artifact custody did not resolve through canonical evidence to the verified artifact identity.');
}
