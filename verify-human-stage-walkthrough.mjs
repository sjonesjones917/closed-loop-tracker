...
try{
  ...
  const result=await evalJs(`(async()=>{
    ...
    if(!compact.includes('.expandable-prompt { height: 280px; max-height: 280px;'))throw new Error('Prompt preview collapsed geometry changed from the approved 280px baseline.');
    if(!compact.includes('.expandable-prompt.expanded { height: auto; max-height: none;'))throw new Error('Expanded prompt geometry no longer reveals the complete instruction.');
