...
# Wrap the existing retained-project fetch block using stable anchors.
...
# Prove an ordinary production navigation does not seed the retained fixture.
...
# Structural verification enforces the production/test boundary.
