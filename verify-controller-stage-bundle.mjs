...
const stageCommands={
  ...
  '23':['verify-production-baseline.mjs','verify-full-cycle.mjs','verify-definition-of-done.mjs'],
...
const fixtureByStage={
  ...
  '23':['wrong-run-count','context-reuse','candidate-mismatch','self-validation','missing-matrix-cell','missing-rca','unexecuted-regression','duplicate-stage17-machinery','missing-baseline-authorization','wrong-baseline-authorization-target','inactive-baseline-authorization','baseline-artifact-mismatch'],
