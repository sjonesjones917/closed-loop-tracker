...
vm.runInContext('const actionControls=new Map();'+extract('function setControlDisabled(','function paintOperatorAction(')+extract('function runOperatorAction(','function focusAfterAction(')+extract('function bindAction(','function bindFileAction(')+extract('function paintHistory(','async function captureCurrentView('),runtime);
const cases=[];
