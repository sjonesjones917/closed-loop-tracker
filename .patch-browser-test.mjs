...
if(!s.includes('closed-loop-stage-response/2'))throw new Error('browser response schema assertion anchor missing');
s=s.replaceAll('closed-loop-stage-response/2','closed-loop-stage-response/3');
