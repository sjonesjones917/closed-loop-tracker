...
const results=[];
for(const [suite,fault,oracle] of [['verify-quarantine-recovery.mjs','quarantine-files','QUARANTINE_FILES_ORACLE'],['verify-filename-transports.mjs','handoff-race','HANDOFF_ASSEMBLY_RACE_ORACLE']]){
