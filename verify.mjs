...
const pa=prompts.buildPromptRecord(2,preparePromptState(2,blank('JOB-A'))).prompt,pb=prompts.buildPromptRecord(2,preparePromptState(2,blank('JOB-B'))).prompt;if(pa.includes('JOB-B')||pb.includes('JOB-A'))throw new Error('Cross-project prompt contamination detected.');
