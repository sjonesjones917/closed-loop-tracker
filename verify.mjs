...
ok(human.includes("fetch(`TEST_PROJECT.json")&&human.includes('stateFromSpec(spec,template)'),'the retained test specification is converted into the ordinary runtime project model');
