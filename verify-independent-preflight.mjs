...
import {recordProposal,evidence,reviewProofFixture,reviewApplicabilityFixture} from './test-fixtures.mjs';
...
function base(jobId){
  ...
  reviewApplicabilityFixture({engine,prompts,ingestion,schema},p);
