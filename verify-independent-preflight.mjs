...
function base(jobId){
  ...
  p.projectData.proofExpressions.push({id:'PROOF-1',stage:6,active:true,scope:{...requirementScope},fields:{PROOF_EXPRESSION_ID:'PROOF-1',TARGET_PROPOSITION_ID:'PROP-1',PROPOSED_EXPRESSION:{type:'LEAF',propositionId:'PROP-1',truthExtraction:'ACCEPTED_ENTAILMENT',evidenceClasses:['OBSERVATION_RECORD','ACCEPTED_ENTAILMENT'],scopeBinding:'CURRENT'},NORMALIZED_EXPRESSION:{type:'LEAF',propositionId:'PROP-1',truthExtraction:'ACCEPTED_ENTAILMENT',evidenceClasses:['OBSERVATION_RECORD','ACCEPTED_ENTAILMENT'],scopeBinding:'CURRENT'},SEMANTIC_EQUIVALENCE_DISPOSITION:'EQUIVALENT',ACCEPTED_SEMANTIC_REVIEW_IDS:['REVIEW-1']},relationships:{TARGET_PROPOSITION_ID:'PROP-1'}});
