...
assert(appCore.includes("if([2,3,4].includes(n))return files.length?"),'Stages 02-04 must consume captured project authority without soliciting the original Stage 01 intent file again.');
