...
assert(/function\s+artifactControlMarkup\s*\(n,locked\)\s*\{\s*if\s*\(n===19\)/.test(appCore),'Stage 19 artifact control must retain the established unchanged-candidate rendering.');
