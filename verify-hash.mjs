...
assert(appCore.includes('function artifactControlMarkup(n,locked){'),'Artifact controls must retain the established renderer; repeat-input prevention belongs to canonical data flow, not UI suppression.');
assert(!/function artifactControlMarkup\(n,locked\)\{\s*if\(n===4\)return ''/.test(appCore),'Stage 04 visual controls must not be hidden as a substitute for canonical intent reuse.');
