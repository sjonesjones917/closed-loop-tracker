...
function createReceipt(project,{stage,promptRecord,rawRecord,validationRecord,proposal}){
  ...
  const receipt={
    ...
    iteration:promptRecord.scope?.iterationId||project.job.CURRENT_ITERATION||'NOT APPLICABLE',runId:promptRecord.scope?.runId||'NOT APPLICABLE',requestDateTime:promptRecord.generatedAt||'UNKNOWN',responseDateTime:rawRecord.createdAt,
