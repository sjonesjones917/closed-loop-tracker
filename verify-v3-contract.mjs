...
assert.match(app,/currentValue\s*:/,'proposal diff model must include the current canonical value for each proposed field or relationship');
assert.match(app,/proposedValue\s*:/,'proposal diff model must include the proposed value beside the current value');
