...
const ADDITIONAL_RECORD_FIELD_TYPES=Object.freeze({
  'INTENT-STATEMENT':Object.freeze({
    INTENT_STATEMENT_ID:Object.freeze({valueType:'STRING',enumValues:Object.freeze([]),nullable:false,normalizerKey:null,closedProperties:null}),
    INPUT_UNIT_ID:Object.freeze({valueType:'STRING',enumValues:Object.freeze([]),nullable:false,normalizerKey:null,closedProperties:null}),
    DISPOSITION:Object.freeze({valueType:'STRING',enumValues:Object.freeze(['INCORPORATED_JOB_DEFINITION','RETAINED_CONTEXT','UNRESOLVED_HUMAN_ONLY','LATER_RESOLVABLE','INAPPLICABLE']),nullable:false,normalizerKey:null,closedProperties:null}),
    CAPTURED_MEANING:Object.freeze({valueType:'STRING',enumValues:Object.freeze([]),nullable:false,normalizerKey:null,closedProperties:null}),
    REASON:Object.freeze({valueType:'STRING',enumValues:Object.freeze([]),nullable:false,normalizerKey:null,closedProperties:null})
  }),
  'OBLIGATION-DISPOSITION':Object.freeze({
    DISPOSITION_ID:Object.freeze({valueType:'STRING',enumValues:Object.freeze([]),nullable:false,normalizerKey:null,closedProperties:null}),
    OBLIGATION_ID:Object.freeze({valueType:'STRING',enumValues:Object.freeze([]),nullable:false,normalizerKey:null,closedProperties:null}),
    DISPOSITION:Object.freeze({valueType:'STRING',enumValues:Object.freeze(['REQUIREMENT','RETAINED_CONTEXT','INAPPLICABLE','BLOCKED']),nullable:false,normalizerKey:null,closedProperties:null}),
    REASON:Object.freeze({valueType:'STRING',enumValues:Object.freeze([]),nullable:false,normalizerKey:null,closedProperties:null})
  }),
  REQ:Object.freeze({
    OBLIGATION_IDS:Object.freeze({valueType:'STRING_ARRAY',enumValues:Object.freeze([]),nullable:false,normalizerKey:null,closedProperties:null})
  }),
  TEST:Object.freeze({
...
const RECORD_SCHEMAS=Object.freeze({
  ...
  requirements:recordSchema({ownership:{...RECORD_OWNERSHIP.requirements,agent:[...RECORD_OWNERSHIP.requirements.agent,'OBLIGATION_IDS']},commitPolicy:COLLECTION_POLICIES.REPLACE_CURRENT_STAGE_SET,title:'Atomic requirements',idField:'REQ_ID',prefix:'REQ',stage:4,fields:[
    'REQ_ID','OBLIGATION_IDS','OBLIGATION','REQUIREMENT_TYPE','MANDATORY_OPTIONAL_STATUS','SOURCE_ID','SOURCE_LOCATION','SOURCE_AUTHORITY','USER_INPUT_RELATIONSHIP',
  ...
  ],required:['OBLIGATION_IDS','OBLIGATION','REQUIREMENT_TYPE','MANDATORY_OPTIONAL_STATUS','APPLICABILITY','OBSERVABLE_SATISFACTION_CONDITION','INTENDED_VERIFICATION_METHOD','EXPECTED_EVIDENCE','FAILURE_CONDITION','SEVERITY','STATUS'],relationships:{SOURCE_ID:'sources'}}),
...
const STAGE_COLLECTIONS=Object.freeze({
  ...
  4:['requirements','obligationDispositions'],
