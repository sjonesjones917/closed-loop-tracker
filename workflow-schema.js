...
const ADDITIONAL_RECORD_FIELD_TYPES=Object.freeze({
  'INTENT-STATEMENT':Object.freeze({
    ...
    REQUIREMENT_RELEVANCE:Object.freeze({valueType:'STRING',enumValues:Object.freeze(['REQUIREMENT','CONTEXT_ONLY','EVIDENCE_ONLY','UNRESOLVED','LATER_RESOLVABLE','INAPPLICABLE']),nullable:false,normalizerKey:null,closedProperties:null}),
  ...
  'OBLIGATION-DISPOSITION':Object.freeze({
    DISPOSITION_ID:Object.freeze({valueType:'STRING',enumValues:[],nullable:false,normalizerKey:null,closedProperties:null}),
    OBLIGATION_ID:Object.freeze({valueType:'STRING',enumValues:[],nullable:false,normalizerKey:null,closedProperties:null}),
    ...
    REASON:Object.freeze({valueType:'STRING',enumValues:[],nullable:false,normalizerKey:null,closedProperties:null}),
    STATUS:Object.freeze({valueType:'STRING',enumValues:[],nullable:false,normalizerKey:null,closedProperties:null})
  }),
  REQ:Object.freeze({
    OBLIGATION_IDS:Object.freeze({valueType:'STRING_ARRAY',enumValues:[],nullable:false,normalizerKey:null,closedProperties:null})
  }),
  TEST:Object.freeze({
...
const RECORD_SCHEMAS=Object.freeze({
  ...
  obligationDispositions:recordSchema({ownership:RECORD_OWNERSHIP.obligationDispositions,commitPolicy:COLLECTION_POLICIES.REPLACE_CURRENT_STAGE_SET,title:'Stage 04 obligation dispositions',idField:'DISPOSITION_ID',prefix:'OBLIGATION-DISPOSITION',stage:4,fields:[
  ...
  requirements:recordSchema({ownership:RECORD_OWNERSHIP.requirements,commitPolicy:COLLECTION_POLICIES.REPLACE_CURRENT_STAGE_SET,title:'Atomic requirements',idField:'REQ_ID',prefix:'REQ',stage:4,fields:[
    'REQ_ID','OBLIGATION','REQUIREMENT_TYPE','MANDATORY_OPTIONAL_STATUS','SOURCE_ID','SOURCE_LOCATION','SOURCE_AUTHORITY','USER_INPUT_RELATIONSHIP','OBLIGATION_IDS',
  ...
  ],required:['OBLIGATION','REQUIREMENT_TYPE','MANDATORY_OPTIONAL_STATUS','OBLIGATION_IDS','APPLICABILITY','OBSERVABLE_SATISFACTION_CONDITION','INTENDED_VERIFICATION_METHOD','EXPECTED_EVIDENCE','FAILURE_CONDITION','SEVERITY','STATUS'],relationships:{SOURCE_ID:'sources'}}),
