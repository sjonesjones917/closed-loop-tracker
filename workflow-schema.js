...
6:['requirements','requirementResolutions','sources','research','evidenceRecords'],
7:['requirements','tests','failureTests','evidenceRecords','artifacts'],
8:['requirements','requirementResolutions','tests','failureTests','sources','research','evidenceRecords'],
9:['instructions','instructionTraces','requirements','tests','failureTests','sources','evidenceRecords'],
10:['instructions','preflightRecords','requirements','tests','failureTests','artifacts','evidenceRecords'],
11:['candidateFreezes','iterations','instructions','requirements','artifacts','runs','freshContexts'],
12:['runs','requirements','tests','freshContexts','artifacts','sources','research','evidenceRecords'],
13:['verification','runs','requirements','tests','defects','evidenceRecords'],
14:['defects','comparisons','verification','runs','requirements','tests','instructions','requirementResolutions','research','sources','changes','evidenceRecords'],
15:['defects','rootCauses','verification','comparisons','requirements','tests','failureTests','regressions','regressionExecutions','artifacts','evidenceRecords'],
16:['defects','rootCauses','regressions','regressionExecutions','requirements','requirementResolutions','tests','instructions','preflightRecords','research','candidateRequirements','sources','artifacts','changes','evidenceRecords'],
17:['changes','candidateFreezes','iterations','instructions','requirements','tests','preflightRecords','regressions','regressionExecutions','artifacts','evidenceRecords'],
18:['iterations','runs','verification','comparisons','defects','rootCauses','requirements','tests','regressions','regressionExecutions','changes','evidenceRecords','blockers'],
...
20:['confirmationRecords','candidateFreezes','iterations','instructions','requirements','tests','regressions','regressionExecutions','artifacts','evidenceRecords'],
21:['baselines','confirmationRecords','instructions','preflightRecords','requirements','tests','artifacts','freshContexts','evidenceRecords'],
22:['products','baselines','requirements','tests','instructions','artifacts','evidenceRecords'],
23:['products','requirements','tests','sources','research','artifacts','evidenceRecords'],
24:['products','requirements','tests','regressions','regressionExecutions','defects','sources','research','artifacts','evidenceRecords'],
25:['products','baselines','requirements','tests','instructions','artifacts','evidenceRecords'],
26:['products','baselines','instructions','requirements','tests','candidateFreezes','iterations','runs','deterministicResults','meaningResults','adversarialResults','representationInspections','regressions','regressionExecutions','artifacts','evidenceRecords'],
27:['products','baselines','confirmationRecords','requirements','tests','deterministicResults','meaningResults','adversarialResults','representationInspections','processAudits','productAudits','defects','blockers','regressions','regressionExecutions','artifacts','evidenceRecords'],
28:['releaseRecords','artifactIdentities','artifacts','products','baselines','processAudits','productAudits'],
29:['sources','research','requirements','instructions','instructionTraces','runs','products','tests','verification','deterministicResults','meaningResults','adversarialResults','representationInspections','processAudits','productAudits','regressions','regressionExecutions','releaseRecords','artifactIdentities','evidenceRecords','evidenceChains','artifacts','baselines'],
