...
const OPERATION_CONTRACT_OVERRIDES=Object.freeze({'3:SEMANTIC_CHALLENGE':Object.freeze({readCollections:Object.freeze(['sources','sourceConflicts']),agentWritableCollections:Object.freeze(['semanticChallenges'])}),'3:RECONCILE_RESEARCH':Object.freeze({readCollections:Object.freeze(['sources','sourceConflicts','research','candidateRequirements','semanticChallenges']),agentWritableCollections:Object.freeze(['semanticReviews'])})});
function amendedOperationContract(stage,operation){const base=s0.operationContract(stage,operation);if(!base)return null;const override=OPERATION_CONTRACT_OVERRIDES[`${stage}:${operation}`]||null,addedAgent=override?[]:(addedAgentCollections[stage]||[]),addedRead=stage>=5?completionReadCollections:[],reconciledResearchRead=stage===4?['semanticReviews']:[],addedApplication=stage===30?['operationReservations','proofObligations','deliveryRecords','deploymentManifests']:['operationReservations','proofObligations'];return Object.freeze({...base,readCollections:Object.freeze([...new Set([...(override?.readCollections||base.readCollections||[]),...addedRead,...reconciledResearchRead])]),agentWritableCollections:Object.freeze([...new Set([...(override?.agentWritableCollections||base.agentWritableCollections||[]),...addedAgent])]),applicationCollections:Object.freeze([...new Set([...(base.applicationCollections||[]),...addedApplication])]),allowedStageData:Object.freeze([...(CONTRACTS[stage]?.allowedStageData||base.allowedStageData||[])])});}
