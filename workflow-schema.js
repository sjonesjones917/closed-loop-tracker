...
const OPERATION_CONTRACT_OVERRIDES=Object.freeze({
  17:Object.freeze({
    FREEZE:Object.freeze({readCollections:Object.freeze(['changes','candidateFreezes','iterations','tests','regressions','regressionExecutions','artifacts']),agentWritableCollections:Object.freeze([]),scopeRequirements:Object.freeze(['projectRevision','inputVersion','sourceSetVersion','requirementsVersion','testSuiteVersion','instructionVersion','iterationId','candidateId'])}),
    EXECUTE_RUN:Object.freeze({readCollections:Object.freeze(['changes','candidateFreezes','iterations','tests','regressions']),agentWritableCollections:Object.freeze(['runs']),scopeRequirements:Object.freeze([...['projectRevision','inputVersion','sourceSetVersion','requirementsVersion','testSuiteVersion','instructionVersion','iterationId','candidateId'],'runId','contextId'])}),
    VERIFY:Object.freeze({readCollections:Object.freeze(['runs','requirements','tests','freshContexts']),agentWritableCollections:Object.freeze(['verification']),scopeRequirements:Object.freeze([...['projectRevision','inputVersion','sourceSetVersion','requirementsVersion','testSuiteVersion','instructionVersion','iterationId','candidateId'],'runId','contextId'])}),
    COMPARE:Object.freeze({readCollections:Object.freeze(['verification','runs','requirements']),agentWritableCollections:Object.freeze(['comparisons']),scopeRequirements:Object.freeze(['projectRevision','inputVersion','sourceSetVersion','requirementsVersion','testSuiteVersion','instructionVersion','iterationId','candidateId'])}),
    ROOT_CAUSE:Object.freeze({readCollections:Object.freeze(['defects','comparisons','verification','requirements']),agentWritableCollections:Object.freeze(['defects','rootCauses']),scopeRequirements:Object.freeze(['projectRevision','inputVersion','sourceSetVersion','requirementsVersion','testSuiteVersion','instructionVersion','iterationId','candidateId'])}),
    REGRESSION:Object.freeze({readCollections:Object.freeze(['defects','rootCauses','regressions','regressionExecutions']),agentWritableCollections:Object.freeze(['regressions','regressionExecutions']),scopeRequirements:Object.freeze(['projectRevision','inputVersion','sourceSetVersion','requirementsVersion','testSuiteVersion','instructionVersion','iterationId','candidateId'])}),
    CORRECT:Object.freeze({readCollections:Object.freeze(['defects','rootCauses','regressions','regressionExecutions','changes']),agentWritableCollections:Object.freeze(['changes']),scopeRequirements:Object.freeze(['projectRevision','inputVersion','sourceSetVersion','requirementsVersion','testSuiteVersion','instructionVersion','iterationId','candidateId'])})
  }),
  19:Object.freeze({
    CONFIRM_FREEZE:Object.freeze({readCollections:Object.freeze(['convergenceRecords','candidateFreezes','iterations','tests','regressions','regressionExecutions','artifacts']),agentWritableCollections:Object.freeze([]),scopeRequirements:Object.freeze(['projectRevision','inputVersion','sourceSetVersion','requirementsVersion','testSuiteVersion','instructionVersion','iterationId','candidateId'])}),
    EXECUTE_RUN:Object.freeze({readCollections:Object.freeze(['candidateFreezes','iterations','tests','regressions']),agentWritableCollections:Object.freeze(['runs']),scopeRequirements:Object.freeze([...['projectRevision','inputVersion','sourceSetVersion','requirementsVersion','testSuiteVersion','instructionVersion','iterationId','candidateId'],'runId','contextId'])}),
    VERIFY:Object.freeze({readCollections:Object.freeze(['runs','requirements','tests','freshContexts']),agentWritableCollections:Object.freeze(['verification']),scopeRequirements:Object.freeze([...['projectRevision','inputVersion','sourceSetVersion','requirementsVersion','testSuiteVersion','instructionVersion','iterationId','candidateId'],'runId','contextId'])}),
    COMPARE:Object.freeze({readCollections:Object.freeze(['verification','runs','requirements']),agentWritableCollections:Object.freeze(['comparisons']),scopeRequirements:Object.freeze(['projectRevision','inputVersion','sourceSetVersion','requirementsVersion','testSuiteVersion','instructionVersion','iterationId','candidateId'])}),
    REGRESSION_VERIFY:Object.freeze({readCollections:Object.freeze(['regressions','regressionExecutions','runs']),agentWritableCollections:Object.freeze(['regressionExecutions']),scopeRequirements:Object.freeze(['projectRevision','inputVersion','sourceSetVersion','requirementsVersion','testSuiteVersion','instructionVersion','iterationId','candidateId'])}),
    CONFIRM:Object.freeze({readCollections:Object.freeze(['convergenceRecords','candidateFreezes','iterations','verification','comparisons','regressionExecutions']),agentWritableCollections:Object.freeze(['confirmationRecords']),scopeRequirements:Object.freeze(['projectRevision','inputVersion','sourceSetVersion','requirementsVersion','testSuiteVersion','instructionVersion','iterationId','candidateId'])})
  })
});
...
globalThis.closedLoopWorkflowSchema=Object.freeze({
  ...
  PROJECT_SCHEMA,WORKFLOW_ID,STAGE_COUNT,VALUE_TYPES,COLLECTION_POLICIES,DEFAULT_RESOURCE_LIMITS,STAGE_OPERATIONS,OPERATION_CONTRACT_OVERRIDES,READ_COLLECTIONS,APPLICATION_COLLECTIONS,HUMAN_ACTIONS,SCOPE_REQUIREMENTS,RECORD_OWNERSHIP,
