...
function jobFieldDefinition(name){
  ...
  if(HUMAN_DECISION_JOB_FIELDS.includes(name))return field(name,PRODUCER.HUMAN_DECISION,{requiredAtStage:null,provenanceRequired:false,nullable:true});
...
const TEST_IR=Object.freeze({
  ...
  limits:Object.freeze({maxTotalInputBytes:16777216,maxDecompressedBytes:33554432,maxSteps:64,maxSelectorDepth:32,maxParsedDepth:64,maxCollectionItems:100000,maxRegexLength:2000,maxRegexInputBytes:1048576,workerExecutionMs:10000,maxArchiveExpansionBytes:33554432,maxCsvCells:250000})
});
