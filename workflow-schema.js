...
const RECORD_OWNERSHIP=Object.freeze({
  ...
  "baselines": {
    ...
    "application": [
      ...
      "BASELINE_AUTHORIZATION_DECISION_ID",
      "APPROVED_VERSIONS",
      "HASHES",
...
const ADDITIONAL_RECORD_FIELD_TYPES=Object.freeze({
  BASELINE:Object.freeze({
    BASELINE_AUTHORIZATION_DECISION_ID:Object.freeze({valueType:'REFERENCE',enumValues:[],nullable:false,normalizerKey:null,closedProperties:null})
  }),
...
const RECORD_SCHEMAS=Object.freeze({
  ...
  baselines:recordSchema({ownership:RECORD_OWNERSHIP.baselines,commitPolicy:COLLECTION_POLICIES.APPLICATION_DERIVED,title:'Production baselines',idField:'BASELINE_ID',prefix:'BASELINE',stage:20,fields:[
    'BASELINE_ID','SUPPORTING_CONFIRMATION_ID','BASELINE_AUTHORIZATION_DECISION_ID','APPROVED_VERSIONS','HASHES','IMMUTABLE_ARTIFACT_RECORDS','AUTHORIZED_RECIPIENT_ROLES','CONTROLLED_STORAGE','HUMAN_AUTHORIZATION','STATUS','EVIDENCE'
  ],required:['BASELINE_AUTHORIZATION_DECISION_ID','APPROVED_VERSIONS','IMMUTABLE_ARTIFACT_RECORDS','AUTHORIZED_RECIPIENT_ROLES','CONTROLLED_STORAGE','HUMAN_AUTHORIZATION','STATUS','EVIDENCE'],relationships:{SUPPORTING_CONFIRMATION_ID:'confirmationRecords',BASELINE_AUTHORIZATION_DECISION_ID:'humanDecisions'}}),
