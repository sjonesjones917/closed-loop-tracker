...
/* CLOSED OPERATION AUTHORITY REGISTRY */
;(()=>{
'use strict';
...
const EXTERNAL_AGENT_WRITES=Object.freeze({
  '1:COMPLETE':Object.freeze([]),'1:SEMANTIC_CHALLENGE':Object.freeze([]),'1:RECONCILE_INTAKE':Object.freeze([]),
  '2:COMPLETE':Object.freeze(['sources','sourceConflicts']),'2:SEARCH_ADEQUACY_REVIEW':Object.freeze([]),'2:RECONCILE_SOURCE_SEARCH':Object.freeze(['sources','sourceConflicts']),
  '3:COMPLETE':Object.freeze(['research','candidateRequirements']),'3:SEMANTIC_CHALLENGE':Object.freeze([]),'3:RECONCILE_RESEARCH':Object.freeze(['research','candidateRequirements']),
  '4:COMPLETE':Object.freeze(['requirements','propositions']),'4:DISPOSITION_CHALLENGE':Object.freeze([]),'4:ATOMICITY_CHALLENGE':Object.freeze([]),'4:RECONCILE_REQUIREMENTS':Object.freeze(['requirements','propositions']),
  '5:COMPLETE':Object.freeze(['requirementResolutions','applicabilityRecords']),'5:SEMANTIC_REVIEW':Object.freeze([]),'5:RECONCILE_REQUIREMENT_SET':Object.freeze(['requirementResolutions','applicabilityRecords']),
  '6:COMPLETE':Object.freeze(['tests','proofExpressions']),'6:PROOF_REVIEW':Object.freeze([]),'6:RECONCILE_VERIFICATION_SUITE':Object.freeze(['tests','proofExpressions']),
  '7:COMPLETE':Object.freeze(['failureTests']),'8:COMPLETE':Object.freeze(['instructions','instructionTraces']),'9:COMPLETE':Object.freeze(['preflightRecords']),
  '11:EXECUTE_RUN':Object.freeze(['runs']),'12:VERIFY':Object.freeze(['verification','observationRecords','entailmentReviews']),'13:COMPARE':Object.freeze(['comparisons']),'14:ROOT_CAUSE':Object.freeze(['defects','rootCauses']),
  '15:COMPLETE':Object.freeze(['regressions']),'16:CORRECT':Object.freeze(['changes']),
  '17:EXECUTE_RUN':Object.freeze(['runs']),'17:VERIFY':Object.freeze(['verification','observationRecords','entailmentReviews']),'17:COMPARE':Object.freeze(['comparisons']),'17:ROOT_CAUSE':Object.freeze(['defects','rootCauses']),'17:REGRESSION':Object.freeze(['regressions','regressionExecutions']),'17:CORRECT':Object.freeze(['changes']),
  '19:EXECUTE_RUN':Object.freeze(['runs']),'19:VERIFY':Object.freeze(['verification','observationRecords','entailmentReviews']),'19:COMPARE':Object.freeze(['comparisons']),
  '21:COMPLETE':Object.freeze(['products']),'22:EXECUTE_EXTERNAL_TEST':Object.freeze(['observationRecords','entailmentReviews','evidenceRecords']),
  '23:COMPLETE':Object.freeze(['meaningResults','observationRecords','entailmentReviews']),'24:COMPLETE':Object.freeze(['adversarialResults','observationRecords','entailmentReviews']),'25:COMPLETE':Object.freeze(['representationInspections','observationRecords','entailmentReviews']),
  '26:COMPLETE':Object.freeze(['processAudits','productAudits']),'26:SEMANTIC_REVIEW':Object.freeze([]),'26:RECONCILE':Object.freeze(['processAudits','productAudits']),
  '27:ADVISORY_REVIEW':Object.freeze(['releaseGateReviews']),'29:INVESTIGATE_MISSING_EVIDENCE':Object.freeze(['evidenceInvestigations','observationRecords','entailmentReviews'])
});

const scopeClass=value=>Object.freeze(Object.fromEntries((value||[]).map(name=>[name,'INPUT_CURRENT'])));
const STAGE_OPERATION_SCOPE_MATRIX=Object.freeze(Object.fromEntries(Object.entries(s0.STAGE_OPERATIONS).flatMap(([stage,operations])=>operations.map(operation=>{
  const base=s0.operationContract(Number(stage),operation);
  return [opKey(stage,operation),Object.freeze({universal:Object.freeze(['jobId','stage','operation','projectRevision','contractProfileId','instructionOrCommandIdentity','scopeHash']),dimensions:Object.freeze([...(base?.scopeRequirements||[])]),classification:scopeClass(base?.scopeRequirements||[])})];
}))));
...
const STAGE_OPERATION_REGISTRY=Object.freeze(Object.fromEntries(Object.entries(s0.STAGE_OPERATIONS).flatMap(([stage,operations])=>operations.map(operation=>{
  ...
  return [opKey(stage,operation),Object.freeze({...base,stage:numericStage,operation,executorClass:authority.executorClass,responseEnvelopeAllowed:authority.responseEnvelopeAllowed,acceptanceMode:authority.acceptanceMode,agentWritableCollections:authority.agentWritableCollections,requiredScope:STAGE_OPERATION_SCOPE_MATRIX[opKey(stage,operation)]})];
}))));
function closedOperationContract(stage,operation){return STAGE_OPERATION_REGISTRY[opKey(stage,operation)]||null;}
globalThis.closedLoopWorkflowSchema=Object.freeze({...s0,APPLICATION_COMMAND_KEYS,ROUTED_EXECUTION_KEYS,HUMAN_DECISION_OPERATION_KEYS,OPERATOR_ACTION_KEYS,STAGE_OPERATION_REGISTRY,STAGE_OPERATION_SCOPE_MATRIX,operationContract:closedOperationContract});
})();
