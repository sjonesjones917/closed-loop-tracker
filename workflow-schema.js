...
proofExpressions:rec({title:'Proof expressions',idField:'PROOF_EXPRESSION_ID',prefix:'PROOF-EXPR',stage:6,agent:['PROPOSED_EXPRESSION','SEMANTIC_RATIONALE'],application:['PROOF_EXPRESSION_ID','TARGET_PROPOSITION_ID','NORMALIZED_EXPRESSION','SEMANTIC_TARGET_SHA256','SEMANTIC_EQUIVALENCE_DISPOSITION','ACCEPTED_SEMANTIC_REVIEW_IDS','CURRENT_SCOPE_HASH','EVALUATION_STATUS'],types:{PROPOSED_EXPRESSION:{valueType:'OBJECT'},NORMALIZED_EXPRESSION:{valueType:'OBJECT'},SEMANTIC_TARGET_SHA256:{valueType:'STRING'},SEMANTIC_EQUIVALENCE_DISPOSITION:{enumValues:E.coverage},ACCEPTED_SEMANTIC_REVIEW_IDS:{valueType:'REFERENCE_ARRAY'}},relationships:{TARGET_PROPOSITION_ID:'propositions'},commitPolicy:C.REPLACE_CURRENT_STAGE_SET}),
proofObligations:rec({title:'Proof obligations',idField:'PROOF_OBLIGATION_ID',prefix:'PROOF-OBLIGATION',stage:6,application:['PROOF_OBLIGATION_ID','PROPOSITION_ID','REQUIREMENT_ID','NORMATIVE_CLASS','APPLICABILITY','PROOF_EXPRESSION_ID','REQUIRED_TEST_IDS','REQUIRED_EVIDENCE_CLASSES','ALLOWED_EPISTEMIC_BASES','LEAF_PROOF_REQUIREMENTS','REQUIRED_ARTIFACT_IDS','REQUIRED_DEPENDENCY_IDS','FRESHNESS_REQUIREMENTS','INDEPENDENCE_REQUIREMENTS','SATISFACTION_STATE','BLOCKING_REASONS','CURRENT_SCOPE_HASH','PROOF_OBLIGATION_SET_HASH'],types:{NORMATIVE_CLASS:{enumValues:E.normative},APPLICABILITY:{enumValues:E.applicability},REQUIRED_TEST_IDS:{valueType:'REFERENCE_ARRAY'},REQUIRED_EVIDENCE_CLASSES:{valueType:'STRING_ARRAY'},ALLOWED_EPISTEMIC_BASES:{valueType:'STRING_ARRAY'},LEAF_PROOF_REQUIREMENTS:{valueType:'OBJECT_ARRAY'},REQUIRED_ARTIFACT_IDS:{valueType:'REFERENCE_ARRAY'},REQUIRED_DEPENDENCY_IDS:{valueType:'REFERENCE_ARRAY'},FRESHNESS_REQUIREMENTS:{valueType:'OBJECT'},INDEPENDENCE_REQUIREMENTS:{valueType:'STRING_ARRAY'},BLOCKING_REASONS:{valueType:'STRING_ARRAY'}},relationships:{PROPOSITION_ID:'propositions',REQUIREMENT_ID:'requirements',PROOF_EXPRESSION_ID:'proofExpressions'},commitPolicy:C.APPLICATION_DERIVED}),
observationRecords:rec({title:'Observation records',idField:'OBSERVATION_ID',prefix:'OBSERVATION',human:['HUMAN_OBSERVED_VALUE'],agent:['EXTERNAL_OR_AGENT_OBSERVED_VALUE'],application:['OBSERVATION_ID','APPLICATION_OBSERVED_VALUE','OBSERVATION_ORIGIN','SUBMITTING_ACTOR_OR_RUNTIME','SUBJECT_ID','OBSERVED_LOCATION','METHOD_OR_TOOL_IDENTITY','INPUT_IDENTITIES_AND_HASHES','OUTPUT_IDENTITIES_AND_HASHES','EPISTEMIC_BASIS','FRESHNESS_STATUS','SOURCE_EVIDENCE_IDS','CURRENT_SCOPE','RAW_OR_NATIVE_PROVENANCE','NORMALIZED_BY_ENTAILMENT_ID','NORMALIZATION_RECEIPT_ID','NORMALIZATION_SOURCE_RECORD_SHA256'],types:{OBSERVATION_ORIGIN:{enumValues:E.origin},EPISTEMIC_BASIS:{enumValues:E.basis},FRESHNESS_STATUS:{enumValues:E.fresh},INPUT_IDENTITIES_AND_HASHES:{valueType:'OBJECT_ARRAY'},OUTPUT_IDENTITIES_AND_HASHES:{valueType:'OBJECT_ARRAY'},SOURCE_EVIDENCE_IDS:{valueType:'REFERENCE_ARRAY'},CURRENT_SCOPE:{valueType:'OBJECT'}},relationships:{SUBJECT_ID:'tests'}}),
entailmentReviews:rec({title:'Entailment reviews',idField:'ENTAILMENT_ID',prefix:'ENTAILMENT',agent:['ENTAILMENT_FINDING','REASONING'],application:['ENTAILMENT_ID','OBSERVATION_ID','TARGET_PROPOSITION_ID','TARGET_LEAF_ID','ACCEPTED_RELATION','ACCEPTED_STATUS','CURRENT_SCOPE','GATE_CONSEQUENCE','ACCEPTANCE_RECEIPT_ID','REVIEWED_OBSERVATION_SHA256'],types:{ENTAILMENT_FINDING:{enumValues:E.entailment},ACCEPTED_RELATION:{enumValues:E.entailment},CURRENT_SCOPE:{valueType:'OBJECT'}},relationships:{OBSERVATION_ID:'observationRecords',TARGET_PROPOSITION_ID:'propositions'}}),
environmentDependencies:rec({title:'Environment dependencies',idField:'DEPENDENCY_ID',prefix:'DEPENDENCY',agent:['DEPENDENCY_DESCRIPTION','PROPOSED_REQUIRED_CONDITION','TARGET_PROPOSITION_IDS','MATERIALITY','FRESHNESS_REQUIREMENT','REQUIRES_ENVIRONMENT_COMPARABILITY','EVIDENCE_REQUIREMENTS'],application:['DEPENDENCY_ID','CURRENT_SCOPE','VERSION_OR_CONDITION','TRUTH_VALUE','EPISTEMIC_BASIS','FRESHNESS_STATUS','AUTHENTICITY_STATUS','RELEASE_CONSEQUENCE','DEPENDENCY_STATE_SHA256'],types:{TARGET_PROPOSITION_IDS:{valueType:'REFERENCE_ARRAY'},MATERIALITY:{enumValues:E.materiality},REQUIRES_ENVIRONMENT_COMPARABILITY:{valueType:'BOOLEAN'},TRUTH_VALUE:{enumValues:E.truth},EPISTEMIC_BASIS:{enumValues:E.basis},FRESHNESS_STATUS:{enumValues:E.fresh}}}),
operationReservations:rec({title:'Operation reservations',idField:'OPERATION_RESERVATION_ID',prefix:'RESERVATION',application:['OPERATION_RESERVATION_ID','JOB_ID','STAGE','OPERATION','TARGET_SLOT','PACKAGE_ID','PROMPT_ID','PROMPT_BODY_SHA256','PROMPT_CONTRACT_SHA256','PROMPT_CONTEXT_SIGNATURE','PROMPT_SCOPE_HASH','SCOPE','EXPECTED_REVISION','CHALLENGE_NONCE','STATUS','OWNING_TAB_INSTANCE','IDEMPOTENCY_KEY','PAYLOAD_HASH','BINDING_RECEIPT_ID','BINDING_RECEIPT_SHA256','BOUND_AT_DEVICE_TIME','CLOSURE_RECEIPT_ID','CLOSURE_RECEIPT_SHA256','CLOSED_AT_DEVICE_TIME','CLOSURE_REASON','CLOSED_BY_REFERENCE'],types:{STAGE:{valueType:'INTEGER'},SCOPE:{valueType:'OBJECT'},EXPECTED_REVISION:{valueType:'INTEGER'},STATUS:{enumValues:E.reservation}},commitPolicy:C.UPDATE_RESERVED}),
disclosureAuthorizations:rec({title:'External package disclosure authorizations',idField:'DISCLOSURE_AUTHORIZATION_ID',prefix:'DISCLOSURE-AUTH',humanDecision:['AUTHORIZED','RECIPIENT_OR_PROVIDER','RECIPIENT_SUITABILITY_CONFIRMED','PURPOSE'],application:['DISCLOSURE_AUTHORIZATION_ID','JOB_ID','STAGE','OPERATION','ARTIFACT_IDS','ARTIFACT_IDENTITIES_AND_HASHES','DISCLOSURE_CLASSIFICATIONS','OUTBOUND_COMPONENT_IDENTITIES_AND_HASHES','OUTBOUND_COMPONENT_CLASSIFICATIONS','OUTBOUND_COMPONENT_SECRET_SCAN_STATUS','OUTBOUND_ALLOWLIST_SHA256','CURRENT_SCOPE_HASH','SECRET_SCAN_STATUS','STATUS','IDENTITY_ASSURANCE'],types:{AUTHORIZED:{valueType:'BOOLEAN'},RECIPIENT_SUITABILITY_CONFIRMED:{valueType:'BOOLEAN'},STAGE:{valueType:'INTEGER'},ARTIFACT_IDS:{valueType:'REFERENCE_ARRAY'},ARTIFACT_IDENTITIES_AND_HASHES:{valueType:'OBJECT_ARRAY'},DISCLOSURE_CLASSIFICATIONS:{valueType:'OBJECT'},OUTBOUND_COMPONENT_IDENTITIES_AND_HASHES:{valueType:'OBJECT_ARRAY'},OUTBOUND_COMPONENT_CLASSIFICATIONS:{valueType:'OBJECT'},OUTBOUND_COMPONENT_SECRET_SCAN_STATUS:{valueType:'OBJECT'},SECRET_SCAN_STATUS:{valueType:'OBJECT'},STATUS:{enumValues:['CURRENT','SUPERSEDED','REVOKED']}},relationships:{ARTIFACT_IDS:'artifacts'},commitPolicy:C.APPEND_SCOPED}),
...
const RS={...s0.RECORD_SCHEMAS,...add};RS.tests=extend(RS.tests,{TEST_PROPOSITION_TEXT:{owner:'agent'},TARGET_PROPOSITION_IDS:{owner:'application',valueType:'REFERENCE_ARRAY'},TESTED_SCOPE:{owner:'agent'},POSITIVE_RESULT_MEANING:{owner:'agent'},NEGATIVE_RESULT_MEANING:{owner:'agent'},SEMANTIC_COVERAGE_DISPOSITION:{owner:'agent',enumValues:E.coverage},SEMANTIC_TARGET_SHA256:{owner:'application',valueType:'STRING'},SEMANTIC_REVIEW_IDS:{owner:'application',valueType:'REFERENCE_ARRAY'},TEST_ROLE:{owner:'agent',enumValues:E.role},RELEASE_BEARING:{owner:'application',valueType:'BOOLEAN'},EXPECTED_VARIANCE_CONTRACT:{owner:'agent',valueType:'OBJECT'},EXPECTED_VARIANCE_CONTRACT_SHA256:{owner:'application'},EXPECTED_VARIANCE_CONTRACT_STATUS:{owner:'application'}});
RS.failureTests=extend(RS.failureTests,{FAILURE_TEST_AVAILABILITY_CLASS:{owner:'agent',enumValues:E.failureAvailability},DEFERRED_EXECUTION_TRIGGER_STAGE:{owner:'agent',valueType:'INTEGER'},DEFERRED_EXECUTION_PLAN:{owner:'agent',valueType:'OBJECT'},EXECUTION_ROUTE:{owner:'agent'},REQUIRED_ARTIFACT_IDS:{owner:'agent',valueType:'REFERENCE_ARRAY'},PROOF_OBLIGATION:{owner:'agent'},DEFERRED_EXECUTION_STATUS:{owner:'application'},DEFERRED_EXECUTION_RECEIPT_ID:{owner:'application'}});
RS.comparisons=extend(RS.comparisons,{EXPECTED_VARIANCE_SET_SHA256:{owner:'application'},VARIANCE_CLASSIFICATIONS:{owner:'application',valueType:'OBJECT_ARRAY'},ENVIRONMENT_DIFFERENCE_RECORDS:{owner:'application',valueType:'OBJECT_ARRAY'}});
RS.candidateFreezes=extend(RS.candidateFreezes,{PROOF_OBLIGATION_SET_ID:{owner:'application'},EXPECTED_VARIANCE_SET_SHA256:{owner:'application'},ENVIRONMENT_DEPENDENCY_SET_SHA256:{owner:'application'},ENVIRONMENT_MANIFEST:{owner:'application',valueType:'OBJECT'}});
RS.baselines=extend(RS.baselines,{PROOF_OBLIGATION_SET_ID:{owner:'application'},ENVIRONMENT_DEPENDENCY_SET_ID:{owner:'application'},EXPECTED_VARIANCE_SET_SHA256:{owner:'application'},ENVIRONMENT_MANIFEST:{owner:'application',valueType:'OBJECT'}});
RS.runs=extend(RS.runs,{DECLARED_ENVIRONMENT_MANIFEST:{owner:'agent',valueType:'OBJECT'},DECLARED_ENVIRONMENT_LIMITATIONS:{owner:'agent'},ENVIRONMENT_MANIFEST_SHA256:{owner:'application'},ENVIRONMENT_COMPARABILITY_STATUS:{owner:'application'}});
...
RS.artifacts=extend(RS.artifacts,{RAW_FILENAME:{owner:'application'},DISPLAY_FILENAME:{owner:'application'},CANONICAL_PATH:{owner:'application'},FILENAME_NORMALIZATION_VERSION:{owner:'application'},COLLISION_KEYS:{owner:'application',valueType:'OBJECT'},AUTHORIZED_DELIVERY_FILENAME:{owner:'application'},DISCLOSURE_CLASSIFICATION:{owner:'application',enumValues:E.disclosure},SECRET_SCAN_STATUS:{owner:'application'},SECRET_SCAN_FINDINGS:{owner:'application',valueType:'OBJECT_ARRAY'},DECLARED_MEDIA_TYPE:{owner:'application'},DETECTED_FORMAT:{owner:'application'},PARSER_ADAPTER_IDENTITY:{owner:'application'},PARSE_CONTRACT:{owner:'application'},POLYGLOT_STATUS:{owner:'application'}});
RS.evidenceRecords=extend(RS.evidenceRecords,{PROVENANCE_SCOPE:{owner:'application',valueType:'OBJECT'},RESPONSE_CONTEXT_ID:{owner:'application'},RESPONSE_RUN_ID:{owner:'application'},NORMALIZATION_RECEIPT_ID:{owner:'application'}});
...
RO.evidenceRecords=RS.evidenceRecords.ownership;for(const collection of['failureTests','comparisons','candidateFreezes','baselines','runs'])RO[collection]=RS[collection].ownership;
/* Section 67 stage fields are an ownership contract, not an invitation for an
   agent to restate application calculations.  Detailed semantic content lives
   in the canonical record families above; these stage fields are summaries,
   identities, or the few expressly agent-authored challenge/search findings. */
const AMENDED_STAGE_FIELDS=Object.freeze({
  1:{agent:['CHALLENGE_FINDING_RECORDS','DISCLOSURE_CLASSIFICATION_SUMMARY'],application:['SEMANTIC_CHALLENGE_REQUIRED','SEMANTIC_CHALLENGE_STATUS','CHALLENGE_CONTEXT_IDS','UNRESOLVED_OMISSION_CHALLENGES','PROMPT_INJECTION_BOUNDARY_APPLIED']},
  2:{agent:['SEARCH_UNIVERSE','SEARCH_PROCEDURE','SEARCH_LOCATIONS','SEARCH_QUERIES_OR_STRATEGIES','SEARCH_CUTOFF','SEARCH_LIMITATIONS','SEARCH_EXECUTION_EVIDENCE','DISCOVERY_RISK'],application:['SOURCE_SEARCH_CONTRACT_ID','SEARCH_ADEQUACY_REVIEW_ID','SOURCE_AUTHENTICITY_SUMMARY','SOURCE_FRESHNESS_SUMMARY']},
  3:{agent:['TIME_SENSITIVE_FINDINGS','SUPERSEDED_MATERIAL','RESEARCH_EPISTEMIC_LIMITATIONS'],application:['SOURCE_AUTHENTICITY_REFERENCES','SOURCE_FRESHNESS_REFERENCES']},
  4:{agent:['PROPOSED_NORMATIVE_CLASSIFICATIONS','CONDITIONAL_ACTIVATION_PROPOSITIONS','PROPOSED_APPLICABILITY_RECORDS','OBLIGATION_DISPOSITION_CHALLENGE_RECORDS','ATOMICITY_CHALLENGE_RECORDS'],application:['PROPOSITION_RECORDS','PROPOSITION_MAPPING_RECORDS','UNRESOLVED_SEMANTIC_CHALLENGES']},
  5:{agent:['PROPOSITION_EQUIVALENCE_REVIEWS','NORMATIVE_CLASSIFICATION_REVIEWS','CONDITIONAL_ACTIVATION_REVIEWS','ATOMICITY_RESOLUTION_RECORDS','PROOF_STRUCTURE_GAPS','RELEASE_OBLIGATION_REDUCTION_REVIEWS'],application:['APPLICABILITY_DETERMINATIONS']},
  6:{agent:['EXPECTED_VARIANCE_CONTRACTS','REQUIRED_EPISTEMIC_BASES','REQUIRED_ENVIRONMENT_DEPENDENCIES','TEST_SEMANTIC_COVERAGE_REVIEW_RECORDS','PROOF_EXPRESSION_SEMANTIC_REVIEW_RECORDS'],application:['PROOF_OBLIGATION_SET_ID','PROOF_OBLIGATION_RECORDS','PROOF_EXPRESSION_RECORDS','TEST_PROPOSITION_RECORDS','TEST_SEMANTIC_COVERAGE_RECORDS','TEST_ROLE_RECORDS','RELEASE_BEARING_TESTS','SEMANTIC_EQUIVALENCE_BLOCKERS']},
  7:{agent:['FAILURE_TEST_AVAILABILITY_CLASS','DEFERRED_EXECUTION_TRIGGER_STAGE','DEFERRED_EXECUTION_PLAN'],application:['DEFERRED_FAILURE_TEST_IDS','EXECUTABLE_NOW_FAILURE_TEST_IDS','FAILURE_OBSERVATION_IDS','FAILURE_ENTAILMENT_RECORDS']},
  8:{agent:['ENVIRONMENT_DEPENDENCY_INSTRUCTIONS','DISCLOSURE_AND_SECRET_HANDLING_RULES','DEFERRED_NEGATIVE_TEST_TRACE_RECORDS'],application:[]},
  9:{agent:['ENVIRONMENT_ASSUMPTION_FINDINGS','PROOF_OBLIGATION_TRACE_FINDINGS','DISCLOSURE_FINDINGS'],application:['INDEPENDENCE_DIMENSION_RECORDS','PROVIDER_CONTEXT_INDEPENDENCE_STATUS','APPLICATION_INPUT_ISOLATION_STATUS']},
  10:{agent:[],application:['PROOF_OBLIGATION_SET_ID','ENVIRONMENT_MANIFEST_ID','EXTERNAL_DEPENDENCY_SET_ID','DISCLOSURE_POLICY_ID','FREEZE_INTEGRITY_BASIS','EXTERNAL_CHECKPOINT_ID']},
  11:{agent:[],application:['APPLICATION_SESSION_DISTINCTNESS','APPLICATION_INPUT_ISOLATION','USER_TRANSFER_CONFORMITY','PROVIDER_CONTEXT_INDEPENDENCE','INDEPENDENCE_LIMITATIONS','ENVIRONMENT_MANIFESTS','EXPECTED_VARIANCE_CONTRACT_ID','OPERATION_RESERVATION_IDS','PACKAGE_IDS','CHALLENGE_NONCES','INPUT_BINDING_BASES']},
  12:{agent:[],application:['REQUIRED_VERIFICATION_RELATION_SET_ID','REQUIRED_RELATION_TUPLES','PROPOSITION_IDS','OBSERVATION_IDS','ENTAILMENT_RELATION_IDS','EPISTEMIC_BASES','FRESHNESS_STATUSES','INDEPENDENCE_DIMENSION_RECORDS','INPUT_BINDING_BASES']},
  13:{agent:[],application:['EXPECTED_VARIANCE_CONTRACT_IDS','ALLOWED_VARIANCES','PROHIBITED_VARIANCES','UNKNOWN_VARIANCES','ENVIRONMENT_DIFFERENCE_RECORDS','PROPOSITION_STABILITY']},
  14:{agent:['PROPOSED_SEVERITY'],application:['AFFECTED_PROPOSITION_IDS','AFFECTED_PROOF_OBLIGATION_IDS','SEVERITY_REVIEW_ID','ACCEPTED_SEVERITY','SEVERITY_DISPUTE_STATUS']},
  15:{agent:[],application:['PROPOSITION_IDS','PROOF_OBLIGATION_IDS','PRE_CORRECTION_OBSERVATION_IDS','PRE_CORRECTION_ENTAILMENT_IDS','POST_CORRECTION_OBSERVATION_IDS','POST_CORRECTION_ENTAILMENT_IDS','RETIREMENT_STATUS','RETIREMENT_AUTHORITY_AND_EVIDENCE']},
  16:{agent:[],application:['CORRECTION_SET_ID','AFFECTED_RECORD_FAMILIES','EARLIEST_RESPONSIBLE_STAGE','RESPONSIBLE_STAGE_MAP_VERSION','ATOMIC_CHANGE_MEMBERS','PROOF_OBLIGATIONS_INVALIDATED','DELIVERY_RECORDS_SUPERSEDED_OR_WITHDRAWN']},
  17:{agent:[],application:['PROOF_OBLIGATION_SET_ID','REQUIRED_VERIFICATION_RELATION_SET_ID','ENVIRONMENT_MANIFEST_SET_ID','INDEPENDENCE_DIMENSION_SUMMARY','EXPECTED_VARIANCE_SUMMARY','DEFERRED_FAILURE_TEST_EXECUTIONS']},
  18:{agent:[],application:['TOTAL_MANDATORY_PROPOSITIONS','SATISFIED_MANDATORY_PROPOSITIONS','PROOF_OBLIGATION_COVERAGE','UNKNOWN_APPLICABILITY_COUNT','UNKNOWN_EQUIVALENCE_COUNT','UNKNOWN_ENTAILMENT_COUNT','EXPIRED_OR_UNKNOWN_FRESHNESS_COUNT','DUE_DEFERRED_TESTS_INCOMPLETE','EVIDENCE_CYCLE_COUNT','UNRESOLVED_SEMANTIC_CHALLENGES']},
  19:{agent:[],application:['CONFIRMATION_REQUIREMENT_CHALLENGE_COMPLETED','NEW_REQUIREMENT_CANDIDATES_FOUND','NEW_REQUIREMENT_CANDIDATE_IDS','CHALLENGE_SCOPE','CHALLENGE_EPISTEMIC_BASIS','PROVIDER_CONTEXT_INDEPENDENCE_SUMMARY','ENVIRONMENT_COMPARABILITY_SUMMARY']},
  20:{agent:[],application:['PROOF_OBLIGATION_SET_ID','ENVIRONMENT_DEPENDENCY_SET_ID','BACKUP_CHECKPOINT_ID','BASELINE_INTEGRITY_BASIS','BASELINE_EXTERNAL_AUTHENTICATION_STATUS']},
  21:{agent:[],application:['PRODUCT_ENVIRONMENT_MANIFEST_ID','PRODUCT_EXTERNAL_DEPENDENCY_SET_ID','PRODUCT_DISCLOSURE_CLASSIFICATION','PACKAGE_ID','OPERATION_RESERVATION_ID','CHALLENGE_NONCE','INPUT_BINDING_BASIS']},
  22:{agent:[],application:['PROPOSITION_IDS','PROOF_OBLIGATION_IDS','OBSERVATION_ORIGINS','OBSERVATION_IDS','ENTAILMENT_RELATION_IDS','EPISTEMIC_BASES','INPUT_BINDING_BASES','RUNTIME_BUILD_IDENTITY','TEST_WORKER_SHA256','PARSER_OR_ADAPTER_IDENTITIES','ENVIRONMENT_MANIFEST_IDS','FRESHNESS_STATUSES']},
  23:{agent:[],application:['PROPOSITION_IDS','OBSERVATION_IDS','ENTAILMENT_RELATION_IDS','EPISTEMIC_BASES','FRESHNESS_STATUSES','INDEPENDENCE_DIMENSION_RECORDS','BLINDNESS_DIMENSION_RECORDS','RESIDUAL_CONTEXT_RISK']},
  24:{agent:[],application:['TARGET_PROPOSITION_IDS','TARGET_PROOF_OBLIGATION_IDS','TARGET_REGRESSION_IDS','OBSERVATION_IDS','ENTAILMENT_RELATION_IDS','EPISTEMIC_BASES','BLINDNESS_DIMENSION_RECORDS','INDEPENDENCE_DIMENSION_RECORDS']},
  25:{agent:[],application:['INSPECTION_RESERVATION_ID','INSPECTED_ARTIFACT_IDS','INSPECTED_ARTIFACT_SHA256_VALUES','VIEWER_IDENTITY_AND_VERSION','OBSERVATION_IDS','ENTAILMENT_RELATION_IDS','INPUT_BINDING_BASIS','HUMAN_IDENTITY_ASSURANCE']},
  26:{agent:['PROPOSITION_RECONCILIATION','APPLICABILITY_RECONCILIATION','EQUIVALENCE_RECONCILIATION','ENTAILMENT_RECONCILIATION','FRESHNESS_RECONCILIATION','ENVIRONMENT_DEPENDENCY_RECONCILIATION'],application:['PROOF_OBLIGATION_SET_ID','EVIDENCE_CYCLE_FINDINGS']},
  27:{agent:[],application:['PRODUCT_RELEASE_ELIGIBILITY','PROOF_OBLIGATION_SET_ID','TOTAL_MANDATORY_PROPOSITIONS','SATISFIED_MANDATORY_PROPOSITIONS','VIOLATED_MANDATORY_PROPOSITIONS','UNDETERMINED_MANDATORY_PROPOSITIONS','UNKNOWN_APPLICABILITY_IDS','INSUFFICIENT_EPISTEMIC_BASIS_IDS','EXPIRED_EVIDENCE_IDS','DUE_DEFERRED_TEST_IDS','DEPENDENCY_BLOCKER_IDS','RELEASE_EVIDENCE_GRAPH_ACYCLIC']},
  28:{agent:[],humanDecision:['HUMAN_DELIVERY_INTENT'],application:['DELIVERY_ARTIFACT_IDENTITY_VERIFIED','HUMAN_DELIVERY_AUTHORIZATION_ID','DELIVERY_AUTHORIZATION_EFFECTIVE','FILENAME_NORMALIZATION_VERSION','FORMAT_INTERPRETATION_RECORDS','CURRENT_BYTE_REVERIFICATION_RECEIPT']},
  29:{agent:[],application:['PROOF_OBLIGATION_SET_ID','PROPOSITION_CHAIN_RECORDS','OBSERVATION_AND_ENTAILMENT_LINKS','EPISTEMIC_BASIS_COVERAGE','FRESHNESS_COVERAGE','ENVIRONMENT_DEPENDENCY_COVERAGE','EVIDENCE_CHAIN_SET_SHA256','JUSTIFICATION_CYCLE_COUNT','DELIVERY_AUTHORIZATION_EFFECTIVE']},
  30:{agent:[],application:['REGRESSION_RETIREMENT_RECORDS','REGISTRY_INTEGRITY_STATUS','REGISTRY_INTEGRITY_HASH','TERMINAL_PROOF_OBLIGATION_SET_HASH','DELIVERY_ID','DELIVERY_STATE','DELIVERY_RECORD_HASH','DELIVERY_AUTHORIZATION_EFFECTIVE','SUPERSEDED_OR_WITHDRAWN_DELIVERY_IDS','POST_RELEASE_REENTRY_STATE']}
});
const BOOLEAN_STAGE_FIELDS=new Set(['PROMPT_INJECTION_BOUNDARY_APPLIED','CONFIRMATION_REQUIREMENT_CHALLENGE_COMPLETED','PRODUCT_RELEASE_ELIGIBILITY','RELEASE_EVIDENCE_GRAPH_ACYCLIC','DELIVERY_ARTIFACT_IDENTITY_VERIFIED','HUMAN_DELIVERY_INTENT','DELIVERY_AUTHORIZATION_EFFECTIVE']);
const NUMBER_STAGE_FIELDS=new Set(['PROOF_OBLIGATION_COVERAGE','EPISTEMIC_BASIS_COVERAGE','FRESHNESS_COVERAGE','ENVIRONMENT_DEPENDENCY_COVERAGE']);
function amendmentStageFieldType(name){if(BOOLEAN_STAGE_FIELDS.has(name))return'BOOLEAN';if(NUMBER_STAGE_FIELDS.has(name))return'NUMBER';if(/(?:^TOTAL_|^SATISFIED_|_COUNT$|_CANDIDATES_FOUND$|_TESTS_INCOMPLETE$)/.test(name))return'INTEGER';if(/(?:_IDS|_SHA256_VALUES|_NONCES)$/.test(name))return'STRING_ARRAY';if(/(?:_RECORDS|_REFERENCES|_FINDINGS|_TUPLES|_MANIFESTS|_BASES|_STATUSES|_VARIANCES|_RECONCILIATION|_LINKS|_SUMMARY|_PLAN|_CONTRACTS|_INSTRUCTIONS|_RULES)$/.test(name))return'OBJECT';return'STRING';}
let SF={...s0.STAGE_FIELDS};for(const[stageText,groups]of Object.entries(AMENDED_STAGE_FIELDS)){const stage=Number(stageText),defs={...(SF[stage]||{})};for(const owner of['agent','humanDecision','application'])for(const name of(groups[owner]||[])){if(defs[name])continue;const producer=owner==='agent'?P.AGENT:owner==='humanDecision'?P.HUMAN_DECISION:P.APPLICATION;defs[name]=s0.field(name,producer,{valueType:amendmentStageFieldType(name),requiredAtStage:null,responsePath:producer===P.AGENT?`/stageData/${name}`:null,derivationKey:producer===P.APPLICATION?`completion.stage${String(stage).padStart(2,'0')}.${name}`:null,provenanceRequired:producer===P.AGENT});}SF[stage]=Object.freeze(defs);}SF=Object.freeze(SF);
const OPS=Object.freeze({...s0.STAGE_OPERATIONS,
  1:Object.freeze(['COMPLETE','SEMANTIC_CHALLENGE','RECONCILE_INTAKE']),
  2:Object.freeze(['COMPLETE','SEARCH_ADEQUACY_REVIEW']),
  4:Object.freeze(['COMPLETE','SEMANTIC_CHALLENGE','DISPOSITION_CHALLENGE','ATOMICITY_CHALLENGE','RECONCILE_REQUIREMENTS']),
  5:Object.freeze(['COMPLETE','NORMATIVE_CLASSIFICATION_REVIEW','APPLICABILITY_REVIEW','PROPOSITION_EQUIVALENCE_REVIEW','RECONCILE_SEMANTIC_CLOSURE']),
  6:Object.freeze(['COMPLETE','SEMANTIC_REVIEW']),
  12:Object.freeze([...new Set([...(s0.STAGE_OPERATIONS[12]||['COMPLETE']),'ENTAILMENT_REVIEW'])]),
  17:Object.freeze([...new Set([...(s0.STAGE_OPERATIONS[17]||[]),'ENTAILMENT_REVIEW'])]),
  19:Object.freeze([...new Set([...(s0.STAGE_OPERATIONS[19]||[]),'ENTAILMENT_REVIEW'])]),
  22:Object.freeze([...new Set([...(s0.STAGE_OPERATIONS[22]||['COMPLETE']),'ENTAILMENT_REVIEW'])]),
  23:Object.freeze([...new Set([...(s0.STAGE_OPERATIONS[23]||['COMPLETE']),'ENTAILMENT_REVIEW'])]),
  24:Object.freeze([...new Set([...(s0.STAGE_OPERATIONS[24]||['COMPLETE']),'ENTAILMENT_REVIEW'])]),
  25:Object.freeze([...new Set([...(s0.STAGE_OPERATIONS[25]||['COMPLETE']),'ENTAILMENT_REVIEW'])])
});
const addStage=(m,n,a)=>Object.freeze({...m,[n]:Object.freeze([...new Set([...(m[n]||[]),...a])])});let SC=s0.STAGE_COLLECTIONS;SC=addStage(SC,4,['propositions']);SC=addStage(SC,5,['propositionEquivalenceReviews','applicabilityRecords']);SC=addStage(SC,6,['proofExpressions','environmentDependencies']);for(const n of[12,17,19,22,23,24,25,29])SC=addStage(SC,n,['observationRecords','entailmentReviews']);let RC=s0.READ_COLLECTIONS;for(let n=5;n<=30;n++)RC=addStage(RC,n,['propositions','propositionEquivalenceReviews','applicabilityRecords','proofExpressions','proofObligations','observationRecords','entailmentReviews','environmentDependencies']);let AC=s0.APPLICATION_COLLECTIONS;for(let n=1;n<=30;n++)AC=addStage(AC,n,['operationReservations','proofObligations']);AC=addStage(AC,30,['deliveryRecords','deploymentManifests']);const CONTRACTS=Object.freeze(Object.fromEntries(Array.from({length:30},(_,i)=>{const n=i+1,b=s0.STAGE_CONTRACTS[n],stageDefs=Object.values(SF[n]||{}),agentFields=stageDefs.filter(d=>d.producer===P.AGENT).map(d=>d.name),humanFields=stageDefs.filter(d=>d.producer===P.HUMAN||d.producer===P.HUMAN_DECISION).map(d=>d.name);return[n,Object.freeze({...b,operations:OPS[n]||b.operations,allowedStageData:Object.freeze(agentFields),humanFields:Object.freeze(humanFields),readCollections:RC[n]||[],agentWritableCollections:SC[n]||[],allowedCollections:SC[n]||[],primaryCollections:SC[n]||[],applicationCollections:AC[n]||[]})];})));
// Observation authoring and semantic-entailment review are deliberately
// separate operations.  A response that reports an observation cannot also
// approve what that observation proves.
const addedAgentCollections=Object.freeze({4:['propositions'],5:['propositionEquivalenceReviews','applicabilityRecords'],6:['proofExpressions','environmentDependencies'],12:['observationRecords'],17:['observationRecords'],19:['observationRecords'],22:['observationRecords'],23:['observationRecords'],24:['observationRecords'],25:['observationRecords'],29:['observationRecords']});
const completionReadCollections=Object.freeze(['propositions','propositionEquivalenceReviews','applicabilityRecords','proofExpressions','proofObligations','observationRecords','entailmentReviews','environmentDependencies']);
function amendedOperationContract(stage,operation){
  stage=Number(stage);if(!(OPS[stage]||[]).includes(operation))return null;
  const inheritedOperation=operation==='ENTAILMENT_REVIEW'&&[17,19].includes(stage)?'VERIFY':operation==='ENTAILMENT_REVIEW'?'COMPLETE':operation;
  const inherited=s0.operationContract(stage,inheritedOperation)||s0.operationContract(stage,'COMPLETE');if(!inherited)return null;
  const addedAgent=addedAgentCollections[stage]||[],isolationKey=`${stage}:${operation}`,isolatedOperations=new Set(['11:COMPLETE','12:COMPLETE','17:EXECUTE_RUN','17:VERIFY','19:EXECUTE_RUN','19:VERIFY','22:COMPLETE','23:COMPLETE','24:COMPLETE','25:COMPLETE']),addedRead=(stage>=5?completionReadCollections:[]).filter(collection=>!isolatedOperations.has(isolationKey)||!['observationRecords','entailmentReviews'].includes(collection)),addedApplication=stage===30?['operationReservations','proofObligations','deliveryRecords','deploymentManifests']:['operationReservations','proofObligations'];
  let writable=[...(inherited.agentWritableCollections||[]),...addedAgent],allowed=[...(CONTRACTS[stage]?.allowedStageData||[])];
  if(stage===1&&operation==='SEMANTIC_CHALLENGE'){writable=[];allowed=['CHALLENGE_FINDING_RECORDS','DISCLOSURE_CLASSIFICATION_SUMMARY'];}
  if(stage===1&&operation==='RECONCILE_INTAKE'){writable=[];allowed=[...CONTRACTS[1].allowedStageData];}
  if(stage===2&&operation==='SEARCH_ADEQUACY_REVIEW'){writable=[];allowed=['SEARCH_EXECUTION_EVIDENCE','DISCOVERY_RISK'];}
  if(stage===4&&['SEMANTIC_CHALLENGE','DISPOSITION_CHALLENGE','ATOMICITY_CHALLENGE'].includes(operation)){writable=[];allowed=operation==='ATOMICITY_CHALLENGE'?['ATOMICITY_CHALLENGE_RECORDS']:['OBLIGATION_DISPOSITION_CHALLENGE_RECORDS'];}
  if(stage===4&&operation==='RECONCILE_REQUIREMENTS'){writable=[...(SC[4]||[])];allowed=[...CONTRACTS[4].allowedStageData];}
  if(stage===5&&operation==='NORMATIVE_CLASSIFICATION_REVIEW'){writable=[];allowed=['NORMATIVE_CLASSIFICATION_REVIEWS','RELEASE_OBLIGATION_REDUCTION_REVIEWS'];}
  if(stage===5&&operation==='APPLICABILITY_REVIEW'){writable=['applicabilityRecords'];allowed=['CONDITIONAL_ACTIVATION_REVIEWS'];}
  if(stage===5&&operation==='PROPOSITION_EQUIVALENCE_REVIEW'){writable=['propositionEquivalenceReviews'];allowed=['PROPOSITION_EQUIVALENCE_REVIEWS'];}
  if(stage===5&&operation==='RECONCILE_SEMANTIC_CLOSURE'){writable=[...(SC[5]||[])];allowed=[...CONTRACTS[5].allowedStageData];}
  if(stage===6&&operation==='SEMANTIC_REVIEW'){writable=[];allowed=['TEST_SEMANTIC_COVERAGE_REVIEW_RECORDS','PROOF_EXPRESSION_SEMANTIC_REVIEW_RECORDS'];}
  const entailmentReview=operation==='ENTAILMENT_REVIEW';if(entailmentReview){writable=['entailmentReviews'];allowed=[];}
  const packageBound=entailmentReview||new Set(['11:COMPLETE','12:COMPLETE','17:EXECUTE_RUN','17:VERIFY','19:EXECUTE_RUN','19:VERIFY','19:REGRESSION_VERIFY','21:COMPLETE','22:COMPLETE','23:COMPLETE','24:COMPLETE','25:COMPLETE']).has(`${stage}:${operation}`),packageIdPolicy=packageBound?'REQUIRED':'NONE';
  const independentSemanticReview=entailmentReview||new Set(['1:SEMANTIC_CHALLENGE','2:SEARCH_ADEQUACY_REVIEW','4:SEMANTIC_CHALLENGE','4:DISPOSITION_CHALLENGE','4:ATOMICITY_CHALLENGE','5:NORMATIVE_CLASSIFICATION_REVIEW','5:APPLICABILITY_REVIEW','5:PROPOSITION_EQUIVALENCE_REVIEW','6:SEMANTIC_REVIEW']).has(`${stage}:${operation}`),perRunVerification=(stage===12&&operation==='COMPLETE')||([17,19].includes(stage)&&operation==='VERIFY'),perRunEntailment=entailmentReview&&[12,17,19].includes(stage),scopeRequirements=(independentSemanticReview||perRunVerification||perRunEntailment)?[...new Set([...(inherited.scopeRequirements||[]),...(perRunVerification||perRunEntailment?['runId']:[]),'contextId'])]:[...(inherited.scopeRequirements||[])];
  const reviewRead=['requirements','tests','propositions','proofExpressions','proofObligations','observationRecords','evidenceRecords','artifacts','runs','freshContexts','products'];
  const readCollections=entailmentReview?reviewRead:[...new Set([...(inherited.readCollections||[]),...addedRead])];
  return Object.freeze({...inherited,operation,scopeRequirements:Object.freeze(scopeRequirements),readCollections:Object.freeze(readCollections),agentWritableCollections:Object.freeze([...new Set(writable)]),applicationCollections:Object.freeze([...new Set([...(inherited.applicationCollections||[]),...addedApplication])]),allowedStageData:Object.freeze([...new Set(allowed)]),reservationRequired:true,packageIdPolicy,responseBindingFields:Object.freeze(['operationReservationId','challengeNonce','packageId'])});
}
function amendedStageFieldDefinition(stage,name){const definition=SF[Number(stage)]?.[name];if(!definition)throw new Error(`Stage ${stage} field ${name} is not registered.`);return definition;}
const schema=Object.freeze({...s0,version:'closed-loop-workflow-schema/3',__controllingCompletionAmendmentVersion:VERSION,CONTROLLING_COMPLETION_ENUMS:E,RECORD_SCHEMAS:Object.freeze(RS),RECORD_OWNERSHIP:Object.freeze(RO),STAGE_FIELDS:SF,STAGE_OPERATIONS:OPS,STAGE_COLLECTIONS:SC,READ_COLLECTIONS:RC,APPLICATION_COLLECTIONS:AC,STAGE_CONTRACTS:CONTRACTS,stageFieldDefinition:amendedStageFieldDefinition,operationContract:amendedOperationContract,allowedCollections:n=>Object.freeze([...(SC[n]||[])]),allowedAgentStageFields:n=>Object.freeze(Object.values(SF[n]||{}).filter(d=>d.producer===P.AGENT).map(d=>d.name)),humanStageFields:n=>Object.freeze(Object.values(SF[n]||{}).filter(d=>d.producer===P.HUMAN||d.producer===P.HUMAN_DECISION).map(d=>d.name)),recordAgentFields:c=>Object.freeze(Object.values(RS[c]?.fieldDefinitions||{}).filter(d=>d.producer===P.AGENT).map(d=>d.name)),recordHumanFields:c=>Object.freeze(Object.values(RS[c]?.fieldDefinitions||{}).filter(d=>d.producer===P.HUMAN||d.producer===P.HUMAN_DECISION).map(d=>d.name))});globalThis.closedLoopWorkflowSchema=schema;
