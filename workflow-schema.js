...
const field=(name,producer,options={})=>Object.freeze({
  ...
  canonicalRatio:producer===PRODUCER.APPLICATION&&['MANDATORY_TEST_COVERAGE','VERIFICATION_COVERAGE'].includes(name),
