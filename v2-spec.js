...
1:`Create a job record before doing any substantive work.
...
• deadline or temporal scope, if any
• known authoritative sources
• available tools
• prohibited actions
• unknown information that may affect correctness

Do not rewrite the user’s objective into a different objective.
Separate explicit user requirements from assumptions.
If a required fact is unknown, record it as UNKNOWN. Do not fill it with an inferred value unless inference is expressly permitted.
Assign a version identifier to the complete input set.`,
...
const ENUMS = Object.freeze({stageStatus:["NOT_STARTED","IN_PROGRESS","COMPLETE","BLOCKED","FAILED"],truth:["TRUE","FALSE","UNKNOWN"],verificationResult:["SATISFIED","VIOLATED","UNDETERMINED"],releaseState:["ACCEPTED","REJECTED","BLOCKED"],sourceRole:["MANDATORY","INFORMATIVE","EVIDENTIARY"],defectCategory:["SOURCE_DEFECT","RESEARCH_DEFECT","REQUIREMENT_DEFECT","TEST_DEFECT","INSTRUCTION_DEFECT","INPUT_DEFECT","EXECUTION_DEFECT","TOOL_DEFECT","AUDIT_DEFECT"],verificationMethod:["FORMAL_PROOF","EXACT_COMPUTATION","DETERMINISTIC_PROGRAMMATIC_TEST","SCHEMA_OR_STRUCTURAL_VALIDATION","EXACT_SOURCE_COMPARISON","RULE_BASED_EVALUATION","INDEPENDENT_SEMANTIC_EVALUATION","AUTHORIZED_HUMAN_JUDGMENT"]});
global.CLV2_SPEC={STAGE_NAMES,STAGE_INSTRUCTIONS,MANDATORY_RULES,ENUMS};
