...
const stage4ReadOld="4:['research','candidateRequirements','sources','evidenceRecords','sourceConflicts']";
const stage4ReadNew="4:['research','candidateRequirements','sources','evidenceRecords','sourceConflicts','semanticReviews']";
if(!oracle.includes(stage4ReadOld))throw new Error('Expected Stage 04 route-oracle read set not found.');
oracle=oracle.replace(stage4ReadOld,stage4ReadNew);
