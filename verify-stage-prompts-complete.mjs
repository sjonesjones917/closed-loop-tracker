...
const semantic={
  ...
  3:['Every current Stage 02 source must receive current research coverage','required conflict-and-exception pass','latest complete pass finds no new material'],
