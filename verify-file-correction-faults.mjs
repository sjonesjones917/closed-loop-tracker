...
const cases=[];
for(const [fault,oracle] of [['input-invalidation','WORK_VERSION_INVALIDATION_ORACLE'],['pending-impact','PENDING_DEPENDENCY_IMPACT_ORACLE'],['candidate-files','CANDIDATE_FILE_RETENTION_ORACLE']]){
