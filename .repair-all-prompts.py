...
if "const PROMPT_ENGINE_VERSION='closed-loop-prompt-engine/27';" in s:
    s=s.replace("const PROMPT_ENGINE_VERSION='closed-loop-prompt-engine/27';","const PROMPT_ENGINE_VERSION='closed-loop-prompt-engine/28';",1)
p.write_text(s)
