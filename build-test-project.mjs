...
if(!prompts.includes('independent external sources'))throw new Error('Stage 02 external-source behavior is not owned by prompt-engine.js.');
...
console.log(JSON.stringify({singleApplicationShell:true,stages:30,retainedJobId:project.jobId,currentStage:2,stage1:'COMPLETE',downstreamFabricated:false,responseSchema:'closed-loop-stage-response/3',obsoleteRuntimeWrappers:false,agentBehaviorOwnedByPromptEngine:true},null,2));
