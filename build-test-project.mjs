...
const activeSource=html+app+prompts+schema+ingestion+fs.readFileSync('test-runtime.js','utf8')+fs.readFileSync('test-worker.js','utf8')+fs.readFileSync('workflow-engine.js','utf8')+fs.readFileSync('project-store.js','utf8')+fs.readFileSync('workbook.js','utf8');
