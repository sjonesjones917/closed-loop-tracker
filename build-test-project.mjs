...
if(!html.includes('experience.js?v=closed-loop-experience-20260823-2055'))throw new Error('Human-facing experience asset is not wired into the single application shell.');
if(!html.includes('closed-loop-30-runtime-20260823-2045'))throw new Error('Expected deployed core cache identity is missing.');
