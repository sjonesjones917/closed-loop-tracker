...
const actualStageOutputs=(raw.generatedOutputs?.length?raw.generatedOutputs:raw.outputReceipts)||[];
...
if(project.generatedPrompts.length!==30||project.agentOutputs.length!==30)throw new Error('Retained project must expose every generated stage instruction and generated stage output.');
