...
if(!/Research only the (?:complete )?current accepted Stage 02 independent external source set/.test(prompts))throw new Error('Canonical Stage 03 source-research boundary is missing.');
