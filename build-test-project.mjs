...
if(project.generatedPrompts.length!==30||project.agentOutputs.length!==30)throw new Error('Retained project must expose every generated stage instruction and output receipt.');
